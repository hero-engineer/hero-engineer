...
function createAddMissingImportsPostTraversal(fileNode: FileNodeType, componentNode: FunctionNodeType) {
  return (ast: ParseResult<File>, importDeclarationsRegistry: ImportDeclarationsRegistry) => {
...
export default createAddMissingImportsPostTraversal
